...
import { openPopup, showWarningPopup } from "./lib/popups";
        ...
        html`
          <li key=${url}>
            <div class="${css.alert} flex justify-between" role="alert">
              ...
              <img
                class="w-5 mr-3 opacity-50 cursor-pointer ml-2"
                src=${timesIcon}
  ...
  return html`
    <div class="p-4">
      <div class="flex align-center mb-4">
        ...
        <h1
          class="font-medium leading-tight text-2xl sm:text-4xl lg:text-5xl leading-none"
        >
      ...
      <h2
        class="font-medium leading-tight text-1xl sm:text-2xl lg:text-3xl mb-4"
      >
      ...
      <form onSubmit=${(e) => submit(e)} class="max-w-sm">
        ...
        <div class="mb-4">
          <button type="submit" class=${css.button}>Add video</button>
        </div>
      </form>
