...
const ChangeThemeButton = ({onClick, colorTheme}) => html`
  <div class="fixed bottom-0 right-0 p-5">
    <span onClick=${onClick} class="w-10 h-10 bg-primary-color block rounded-full shadow-lg cursor-pointer text-white flex items-center justify-center transition duration-500">
